...
bot.on('ready', () => {
    ...
    let status = [
        {name: 'Use z.help caso tenha dúvida.', type: 'WATCHING', url: 'https://www.twitch.tv/tutekinho2'},
        {name: 'ao 𝘾𝙎:𝙂𝙊 𝙎𝘼𝙇𝘾𝙃𝙄𝘾𝙃𝘼𝙎 ', type: 'WATCHING', url: 'https://www.twitch.tv/tutekinho2'},
